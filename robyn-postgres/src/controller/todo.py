...
async def create_todo(request):
    with sessionlocal as db:
        todo = request.json()
        response = repository.todo.create_todo(db, todo)
...
async def get_todo_by_id(request):
    ...
    with sessionlocal as db:
        response = repository.todo.get_todo_by_id(db, id)
...
async def get_all_todo(request):
    with sessionlocal as db:
        response = repository.todo.get_all_todo(db)
...
async def update_todo(request):
    ...
    with sessionlocal as db:
        response = repository.todo.update_todo_by_id(db, id, todo)
...
async def delete_todo_by_id(request):
    ...
    with sessionlocal as db:
        success = repository.todo.delete_todo_by_id(db, id)
